...
import IconJava from '~icons/vscode-icons/file-type-jar'
...
<template>
    <div id="spronkle" class="relative h-96 w-[21.2rem] rounded-md bg-slate-600 text-center hover:shadow-md hover:bg-slate-500">
        <Head>
            <title>Who Am I? || Connek's Portfolio</title>
        </Head>
        ...
        <p class="text-base font-quicksand bold px-2 text-gray-50">
            I'm Connek, a British developer who works day and night.<br />
            I major in front-end development, but I do know some back-end too, especially APIs.<br />
            I know a lot of languages, and while I can't say I'm a professional in all of them, I do know some reference about them.
            Some of the languages/frameworks I know include:
        </p>

        <ul class="whitespace-nowrap table m-auto border-separate border-spacing-1">
            <li class="table-cell"><icon-kotlin class="font-size-8" /></li>
            <li class="table-cell"><icon-csharp class="font-size-8" /></li>
            <li class="table-cell"><icon-js class="font-size-8" /></li>
            <li class="table-cell"><icon-ts class="font-size-8" /></li>
            <li class="table-cell"><icon-php class="font-size-8" /></li>
            <li class="table-cell"><icon-java class="font-size-8" /></li>
        </ul>

        <ul class="whitespace-nowrap table m-auto border-separate border-spacing-1">
            <li class="table-cell"><icon-vue class="font-size-8" /></li>
            <li class="table-cell"><icon-nuxt class="font-size-8" /></li>
            <li class="table-cell"><icon-reactjs class="font-size-8" /></li>
            <li class="table-cell"><icon-html class="font-size-8" /></li>
            <li class="table-cell"><icon-css class="font-size-8" /></li>
        </ul>
    </div>
</template>
